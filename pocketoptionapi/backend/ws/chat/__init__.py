...
# Função: Bot WebSocket para comunicação com servidor
# Descrição:
# - Estabelece e gerencia conexão WebSocket
# - Registra eventos (abertura, mensagens, erros, fechamento) em log
# - Exibe mensagens e erros no console
"""
