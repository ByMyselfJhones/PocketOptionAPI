...
# Função: Cliente WebSocket assíncrono para comunicação com servidor
# Descrição:
# - Estabelece conexão WebSocket com reconexão automática
# - Processa mensagens (exibe, responde pings, autentica com sessão)
# - Suporta envio de ordens (desativado)
"""
