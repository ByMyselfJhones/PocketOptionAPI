...
# Função: Envio de ordens via WebSocket para plataforma de negociação
# Descrição:
# - Buyv3: Abre ordens demo com duração e expiração calculada
# - Buyv3_by_raw_expired: Abre ordens binárias/turbo com expiração definida
# - Envia mensagens formatadas via WebSocket
"""
