...
# Função: Interface para operações com a API da Pocket Option
# Descrição:
# - Gerencia conexão WebSocket e operações assíncronas
# - Executa compras e verifica resultados de ordens
# - Consulta payouts, candles e dados históricos
# - Processa dados de mercado em DataFrames
"""
