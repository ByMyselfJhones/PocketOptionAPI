...
# Função: API para interação com plataforma de negociação via WebSocket
# Descrição:
# - Gerencia conexão WebSocket com sincronização de tempo
# - Suporta ordens de compra, consulta de saldos, velas e troca de símbolos
# - Envia mensagens JSON e monitora status da conexão
"""
