...
# Função: Módulo utilitário para gerenciamento de dados e logs
# Descrição:
# - Cria diretórios e gerencia variáveis globais para trading
# - Registra logs com níveis (INFO, DEBUG, ERROR)
# - Manipula arquivos CSV (preços, candles) e cache JSON
"""
