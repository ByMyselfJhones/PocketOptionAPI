...
# Função: Utilitários para manipulação de datas e timestamps
# Descrição:
# - Converte datetime para timestamp
# - Calcula tempo de expiração ajustado para segundo :30 com acréscimo de 2 horas
# - Gera lista de tempos de expiração futuros com durações variadas
"""
