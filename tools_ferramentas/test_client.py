...
# Descrição:
# - Implementa um cliente WebSocket assíncrono para conexão com a API da Pocket Option.
# - Tenta conectar a múltiplas URLs de regiões definidas em REGIONS.get_all().
# - Gerencia mensagens do servidor, incluindo ping-pong (2/3) e autenticação com sessão.
# - Suporta envio de mensagens, como autenticação, e exibe mensagens recebidas (limitando bytes a 100 caracteres).
# - Inclui tratamento de erros e reconexão em caso de falha na conexão.
"""
